...
# The escaped HEREDOC means thatsingularity_tmp_file we need to substitute in $singularity_tmp_file ourselves
...
({
timeout <%= script_timeout.to_s %>s /bin/bash --login $singularity_tmp_file <%= arguments %>
